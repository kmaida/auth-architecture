...
19. Backend sets an `httpOnly` cookie for the user's session ID (this only contains the session ID, never tokens)

20. Backend `/auth/callback` redirects to the frontend

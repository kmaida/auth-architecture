function HomePage() {
  return (
    ...
    <p>This is a demo of the <strong>Browser-based OAuth 2.0 Client</strong> architecture pattern, specifically as described in the <a href="https://datatracker.ietf.org/doc/html/draft-ietf-oauth-browser-based-apps#name-browser-based-oauth-20-clie" target="_blank">OAuth 2.0 for Browser-Based Applications</a> specification draft. This is a serverless architecture; there is no backend and the frontend direclty interacts with the authorization server (<a href="https://fusionauth.io" target="_blank">FusionAuth</a>). Access tokens are requested by the frontend so the frontend can call the resource server. It should store tokens in local app memory, <em>not</em> in localStorage. <a href="https://datatracker.ietf.org/doc/html/draft-ietf-oauth-browser-based-apps#section-6.3.3" target="_blank">Browser-based OAuth 2.0 Client is the least secure</a> of the three architecture patterns for browser-based apps, and it is even more important to follow [best current practices for OAuth security](https://www.ietf.org/rfc/rfc9700.html).</p>
    ...
    <ul>
      ...
      <li>
        Session persistence with refresh token grant (includes refresh token rotation)
      </li>
      <li>
